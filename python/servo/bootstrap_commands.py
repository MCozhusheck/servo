...
class MachCommands(CommandBase):
    ...
    @CommandArgument("--force", "-f", action="store_true", help="Force reinstall Rust tools even if already present")
    @CommandArgument("--yes", "-y", action="store_true", help="Answer yes to all prompts (for package installation)")
